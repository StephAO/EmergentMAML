...
class Data_Handler:
    ...
    def __init__(self, images_per_instance=1, batch_size=1, group=True):
        ...
        self.data_file = '{}/annotations/instances_{}.json'.format(self.coco_dir, self.data_type)
        self.caption_file = '{}/annotations/captions_{}.json'.format(self.coco_dir, self.data_type)
    ...
    def split_train_val(self):
        ...
        for img_id in all_img_ids:
            ...
            possible_categories = {}
            if len(anns) == 0:  # If image has no category, place in "other" category bin
        ...
        while self.group or data_idx + self.images_per_batch < len(data):
            ...
            for b in range(self.batch_size):
                ...
                for i in gen:
                    ...
                    with open('{}/images/{}/{}'.format(self.coco_dir, self.feat_dir, img['file_name']), "rb") as f:
                        img = pickle.load(f)
    ...
    def generate_all_encodings(self):
        ...
        dir = '{}/images/{}'.format(self.coco_dir, self.feat_dir)
        ...
        for img_id in img_list:
            ...
            img_path = '{}/images/{}/{}'.format(self.coco_dir, self.data_type, img_fn)
            ...
            with open('{}/images/{}/{}'.format(self.coco_dir, self.feat_dir, img_fn), "wb") as f:
